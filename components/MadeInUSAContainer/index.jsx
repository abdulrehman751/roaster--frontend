  ...
  <section className="py-16 px-4 md:px-12">
    ...
    <div className="mt-12">
      <div className="bg-[#00997A] rounded-xl flex flex-col md:flex-row items-center justify-between px-8 py-8 gap-4">
        ...
        <button className="border border-white text-white font-bold rounded-xl px-6 py-3 bg-transparent hover:bg-white hover:text-[#00997A] transition">Get a Quote</button>
